...
//                                    data.addXValue(time[0].substring(6, 8) + "/" + time[0].substring(10, 12));

                                    if (type[0] == 0) {
                                        yVals1.add(new BarEntry(1, 0));
                                        total_type_1++;
                                    } else if (type[0] == 1) {
                                        yVals2.add(new BarEntry(1, 0));
                                        total_type_2++;
                                    }
                                    index++;
                                    ...
                                    for (int i = data_size - 1; i >= 0; i--) {
                                        ...
                                        if (i == 0) {
                                            ...
                                            yVals1.add(new BarEntry(barchart_type1_data, index));
                                            yVals2.add(new BarEntry(barchart_type2_data, index));
//                                            data.addXValue(time[i].substring(6, 8) + "/" + time[i].substring(10, 12));
                                            index++;
...
//                                            data.addXValue(time[i].substring(6, 8) + "/" + time[i].substring(10, 12));
                            ...
                            if (yVals1.size() < 3) {
                                ...
                                for (int ii = 0; ii < 3 - yVals1.size(); ii++) {
...
//                                    data.addXValue("");
                            ...
                            set1.setValueTypeface(tfs);
                            set2.setValueTypeface(tfs);
                            ...
                            mChart.setData(data);
                            mChart.setVisibleXRange(18f, 18f);
